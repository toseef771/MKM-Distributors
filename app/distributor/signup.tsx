...
export default function DistributorSignup() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (snap.exists()) {
        Alert.alert("Already Registered", "An account with this phone number already exists. Please login.");
        setLoading(false);
        return;
      }
      ...
      Alert.alert(
        ...
        [{ text: "Go to Login", onPress: () => router.replace("/distributor/login") }]
      );
    } catch (err: any) {
      ...
      >
        ...
        >
          ...
          <View style={styles.form}>
            ...
            <StyledInput
              label="Phone Number (Your Unique ID)"
